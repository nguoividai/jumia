          ...
          <ModalChooseProduct
            ...
            trigger={
              <ListGroup.Item>
                <div className="row">
                  <div className="col-9">
                    <div className="product-title">American Cheese Supreme - Veg</div>
                    ...
                    <div className="product-description">
                      A burger with crispy corn and cheese patty covered with a slice of cheese,
                      creamy cocktail sauce, jalapeos and shredded onions.
                    </div>
                  </div>
                  <div className="col-3">
